/*
 * Copyright for Xueshandai Refactoring Project
 * Common Javascript for Xueshandai Refactoring
 * Author: Xueshandai Technology Architect, Zhang Xiaodong
...
Event.observe(window,'unload',Event.unloadCache,false);
			...
			Popup.prototype={
				iframeIdName:'ifr_popup',initialize:function(config){
					...
					this.color={
						cColor:"#000000",bColor:"#FFFFFF",tColor:"#cccccc",wColor:"grey"
					};
					this.dropClass=null;
					this.someToHidden=[];
		 ...
		 Dragdrop.prototype={
			...
			mousemove:function(event){
				...
				if(this.showShadow){
					G('dialogBoxShadow').style.left=iLeft+this.shadowWidth+"px";G('dialogBoxShadow').style.top=iTop+this.shadowWidth+"px";
				};
				this.dragData={
					x:Event.pointerX(event),y:Event.pointerY(event)
				};
	 ...
	 function openshow(url,title,w,h,stype){
		   ...
		   g_pop.setContent("title",title);g_pop.setContent("contentUrl",url);g_pop.build();g_pop.show();
	}
	function g_close_pop_re(){
		   g_pop.close();location.reload();
    }
...
function ShowIframe(){
            var pop=new Popup({ contentType:1,scrollType:'yes',isReloadOnClose:false,width:780,height:450});
            pop.setContent("contentUrl","../Message/Select_Receiver.html");
            pop.setContent("title","新增充值通道");
            pop.build();
            pop.show();
}

//Show Pkg Order condition
function ShowIframeOrder(){
            var pop=new Popup({ contentType:1,scrollType:'yes',isReloadOnClose:false,width:780,height:450});
            pop.setContent("contentUrl","../Message/Select_Order_Condition.html");
            pop.setContent("title","设置度假订单筛选条件");
            pop.build();
            pop.show();
}

//show Pkg pause setup
function ShowIframePausePkgMessage(){
            var pop=new Popup({ contentType:1,scrollType:'yes',isReloadOnClose:false,width:480,height:250});
            pop.setContent("contentUrl","../Message/Pause_Pkg_Message.html");
            pop.setContent("title","设置度假通知暂缓时间");
            pop.build();
            pop.show();
}

//show Pkg prompt reply
function ShowIframePkgPromptReply(){
            var pop=new Popup({ contentType:1,scrollType:'yes',isReloadOnClose:false,width:780,height:450});
            pop.setContent("contentUrl","../Message/Prompt_Reply_Pkg_Message.html");
            pop.setContent("title","度假通知催回复");
            pop.build();
            pop.show();
}

//show hotel pause setup
function ShowIframePauseHotelMessage(){
            var pop=new Popup({ contentType:1,scrollType:'yes',isReloadOnClose:false,width:780,height:350});
            pop.setContent("contentUrl","../Message/Pause_Hotel_Message.html");
            pop.setContent("title","设置酒店通知暂缓时间");
            pop.build();
            pop.show();
}

// show hotel message appointment window
function ShowIframeAppointmentHotelMessage(){
            var pop=new Popup({ contentType:1,scrollType:'yes',isReloadOnClose:false,width:780,height:350});
            pop.setContent("contentUrl","../Message/Appointment_Hotel_Message.html");
            pop.setContent("title","设置酒店通知预约时间");
            pop.build();
            pop.show();
}

// show hotel message shift window
function ShowIframeShiftHotelMessage(){
            var pop=new Popup({ contentType:1,scrollType:'yes',isReloadOnClose:false,width:480,height:250});
            pop.setContent("contentUrl","../Message/Shift_Hotel_Message.html");
            pop.setContent("title","设置酒店通知交班时间");
            pop.build();
            pop.show();
}

//show hotel provice
function ShowIframeFilter_Hotel(){
            var pop=new Popup({ contentType:1,scrollType:'yes',isReloadOnClose:false,width:630,height:435});
            pop.setContent("contentUrl","../Message/Filter_Hotel_Message.html");
            pop.setContent("title","设置业务员查看省市");
            pop.build();
            pop.show();
}

//show hotel prompt reply
function ShowIframeHotelPromptReply(){
            var pop=new Popup({ contentType:1,scrollType:'yes',isReloadOnClose:false,width:780,height:450});
            pop.setContent("contentUrl","../Message/Prompt_Reply_Hotel_Message.html");
            pop.setContent("title","酒店通知催回复");
            pop.build();
            pop.show();
}

//show flight pause setup
function ShowIframePauseFlightMessage(){
            var pop=new Popup({ contentType:1,scrollType:'yes',isReloadOnClose:false,width:480,height:250});
            pop.setContent("contentUrl","../Message/Pause_Flight_Message.html");
            pop.setContent("title","设置机票通知暂缓时间");
            pop.build();
            pop.show();
}

// show Flight message appointment window
function ShowIframeAppointmentFlightMessage(){
            var pop=new Popup({ contentType:1,scrollType:'yes',isReloadOnClose:false,width:780,height:350});
            pop.setContent("contentUrl","../Message/Appointment_Flight_Message.html");
            pop.setContent("title","设置机票通知预约时间");
            pop.build();
            pop.show();
}

// show Flight message shift window
function ShowIframeShiftFlightMessage(){
            var pop=new Popup({ contentType:1,scrollType:'yes',isReloadOnClose:false,width:480,height:350});
            pop.setContent("contentUrl","../Message/Shift_Flight_Message.html");
            pop.setContent("title","设置机票通知交班时间");
            pop.build();
            pop.show();
}

//show Flight prompt reply
function ShowIframeFlightPromptReply(){
            var pop=new Popup({ contentType:1,scrollType:'yes',isReloadOnClose:false,width:780,height:450});
            pop.setContent("contentUrl","../Message/Prompt_Reply_Flight_Message.html");
            pop.setContent("title","机票通知催回复");
            pop.build();
            pop.show();
}

// show Flight SKandK Condition window
function ShowIframeSKandK_Condition(){
            var pop=new Popup({ contentType:1,scrollType:'yes',isReloadOnClose:false,width:480,height:350});
            pop.setContent("contentUrl","../Message/SKandK_Condition.html");
            pop.setContent("title","设置SK&K位条件");
            pop.build();
            pop.show();
}

// show Flight Message_Category_Condition window
function ShowIframeFlightMessage_Category_Condition(){
            var pop=new Popup({ contentType:1,scrollType:'yes',isReloadOnClose:false,width:780,height:450});
            pop.setContent("contentUrl","../Message/Message_Category_Condition.html");
            pop.setContent("title","机票重要通知类别选择条件");
            pop.build();
            pop.show();
}

// show Flight Airfoce_Condition window
function ShowIframeFlight_Order_Condition(){
            var pop=new Popup({ contentType:1,scrollType:'yes',isReloadOnClose:false,width:780,height:450});
            pop.setContent("contentUrl","../Message/Flight_Order_Condition.html");
            pop.setContent("title","设置订单筛选条件");
            pop.build();
            pop.show();
}

// show Flight Order_Condition window
function ShowIframeAirfoce_Condition(){
            var pop=new Popup({ contentType:1,scrollType:'yes',isReloadOnClose:false,width:780,height:450});
            pop.setContent("contentUrl","../Message/Airfoce_Condition.html");
            pop.setContent("title","设置航空公司筛选条件");
            pop.build();
            pop.show();
}
